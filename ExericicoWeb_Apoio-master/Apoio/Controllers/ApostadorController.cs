...
namespace Apoio.Controllers
{
    public class ApostadorController : Controller
    {
        ...
        // GET: Apostadors/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: Apostadors/Create
